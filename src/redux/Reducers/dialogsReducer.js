...
const onMessActionCreate = (text) => ({ type: UPDATE_NEW_MESS, newText: text })
const addMessActionCreate = () => ({ type: ADD_MESS });

export {dialogsReducer, onMessActionCreate, addMessActionCreate};